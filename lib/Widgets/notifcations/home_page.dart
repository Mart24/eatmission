...
import 'package:food_app/Widgets/notifcations/widgets/actions_buttons.dart';
...
class _NotificationPageState extends State<NotificationPage> {
  ...
  TextEditingController _textEditingController =
      TextEditingController(text: "Vergeet niet te tracken :)");
  ...
  Future<void> onCreate() async {
    await notificationService.showNotification(
      ...
      "Een nieuwe reminder is ingesteld.",
      jsonEncode({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Notificatie voor jezelf"),
        centerTitle: true,
        // actions: [
        //   IconButton(
        //     onPressed: () {
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text("Alle notificaties staan uit"),
                          ),
                        );
                      },
